...
export default function Header() {
 ...
 <>
  ...
  <ul>
    ...
    {/* {userId!==""?( */}
    <li>
      <Button href="/useradd" className="nav-link" onClick={refreshPage}>
      <h2 style={{color:'black',fontFamily:"'Mukta', sans-serif",fontWeight:"bold",fontStyle:'italic'}}>Put Ad</h2>
      </Button>
    </li>
    {/* ):""} */}
    <li>
      <Button href="/viewall" className="nav-link" onClick={refreshPage}>
      <h2 style={{color:'black',fontFamily:"'Mukta', sans-serif",fontWeight:"bold",fontStyle:'italic'}}>See all verifed/rejectd ads</h2>
      </Button>
    </li>

    <li>
      <Button href="/search" className="nav-link" onClick={refreshPage}>
      <h2 style={{color:'black',fontFamily:"'Mukta', sans-serif",fontWeight:"bold",fontStyle:'italic'}}>Admin</h2>
      </Button>
    </li>
